    ...
    <>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          Ça m'a permis de poursuivre l'apprentissage des technologies que
          j'avais pratiqué durant mon stage, et même si le projet n'est pas
          resté longtemps en vie, je n'en ai tiré que des bénéfices. En
          parallèle du site, j'ai également créer un bot discord permettant de
          parser et mettre en forme des données de plusieurs sites afin de
          faciliter l'avancé des gens qui jouaient au jeu.
        </p>

        <p>
          Après le DUT, je me suis dirigé vers une Licence 3 Informatique, mais
          dû à des problèmes avec la bourse, je n'ai pas pu terminer mon année.
